	  ...
	  BEGIN	
		...
		ELSE
			BEGIN
				...
				SET @value1 = (	SELECT value FROM @distanceTable WHERE i = @i-1 and j = @j-1 );
				SET @value2 = (	SELECT value FROM @distanceTable WHERE i = @i and j = @j-1 );
				SET @value3 = (	SELECT value FROM @distanceTable WHERE i = @i and j = @j-1 );
               ...
               INSERT INTO @distanceTable VALUES(@i,@j,@tempValue+1);
    end
